...
export default class Buttons {
    ...
    static async initialize({ scene, camera, domElement }) {
        ...
        this.#instances = Array.from({ length: MAX_COLORS }, () =>
            Array.from({ length: TYPES }, () => [])
        );
    ...
    static #onPointerUp(event) {
        // Optionnel : Réinitialiser l'état des boutons enfoncés si besoin
    }
